...
class PullOver : public TrafficRule {
    ...
    private:
        ...
        int BuildStopDecision(const std::string& vistual_obstacle_id_postfix, const double stop_line_s,
                              const common::PointENU& stop_point, const double stop_point_heading);
