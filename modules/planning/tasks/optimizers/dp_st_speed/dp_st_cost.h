...
class DpStCost {
    public:
        explicit DpStCost(const DpStSpeedConfig& dp_st_speed_config, const std::vector<const Obstacle*>& obstacles,
        ...
        double GetSpeedCost(const STPoint& first, const STPoint& second, const double speed_limit) const;
        ...
        double GetJerkCostByThreePoints(const double first_speed, const STPoint& first_point,
