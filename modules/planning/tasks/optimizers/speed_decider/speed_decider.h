...
class SpeedDecider : public Task {
    ...
    private:
        ...
        StPosition GetStPosition(const PathDecision* const path_decision, const SpeedData& speed_profile,
                                 const StBoundary& st_boundary) const;

        bool CheckKeepClearCrossable(const PathDecision* const path_decision, const SpeedData& speed_profile,
        ...
        bool CreateStopDecision(const Obstacle& obstacle, ObjectDecisionType* const stop_decision,
