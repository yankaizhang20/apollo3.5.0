...
class PncMap {
    public:
        ...
        //@zyk:读取路由响应信息，读取RoadSegment、Passage、LaneSegment，总的来说是处理所有LaneSegment
        ...
        bool GetRouteSegments(const common::VehicleState &vehicle_state, const double backward_length,
        ...
        bool ExtendSegments(const RouteSegments &segments, const common::PointENU &point, double look_forward,
                            double look_backward, RouteSegments *extended_segments);

        bool ExtendSegments(const RouteSegments &segments, double start_s, double end_s,
    ...
    private:
        ...
        bool ProjectToSegments(const common::PointENU &point_enu, const RouteSegments &segments,
         ...
         */
        //@zyk:将routing的LaneSegment转换为Pnc_map的LaneSegment
    ...
    private:
        ...
        struct WaypointIndex {
                ...
                int index;
                WaypointIndex(const LaneWaypoint &waypoint, int index) : waypoint(waypoint), index(index) {}
        };
