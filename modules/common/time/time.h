...
class Clock {
    public:
        ...
        static void SetNowInSeconds(double seconds) {
                ...
                clock->mock_now_ = Timestamp(std::chrono::duration_cast<Duration>(duration_sec));
        }
...
inline Clock::Clock() : Clock(FLAGS_use_cyber_time ? ClockMode::CYBER : ClockMode::SYSTEM) {}
